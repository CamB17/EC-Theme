<?
/*add_action( 'admin_menu', 'ec_add_menu_pages' );

function ec_add_menu_pages() {
  //add_menu_page( 'AOR SEO', 'AOR SEO', 'manage_options', 'ec_admin_seo', 'ec_admin_seo_page', 'dashicons-tickets', 6  );
}

function ec_save_by_ajax() {
  https://support.advancedcustomfields.com/forums/topic/use-update_field-with-ajax/
}

function ec_admin_seo_page() {
