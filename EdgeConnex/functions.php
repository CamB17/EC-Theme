...
require_once ('includes/alert_bar.php');
...
//require_once ('includes/search-acf.php');            // Custom ACF Searc


if($_SERVER['SERVER_NAME'] === 'edge.1.aordev.com') 
{
    add_filter('wp_get_attachment_url', function ($url) 
    {
      $parsed_url = parse_url( $url );
			...
			return str_replace('https://edge.1.aordev.com', 'https://www.edgeconnex.com', $url);
